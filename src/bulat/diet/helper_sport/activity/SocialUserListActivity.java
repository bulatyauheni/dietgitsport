		...
		//tabs
				...
				buttonProfile.setOnClickListener(new OnClickListener() {
					public void onClick(View v) {
						...
						intent.putExtra(SocialDishActivity.USERHEIGHT, String.valueOf((SaveUtils.getHeight(SocialUserListActivity.this) + Info.MIN_HEIGHT)));
						if(!"0".equals( SaveUtils.getSex(SocialUserListActivity.this))){
						...
						intent.putExtra(SocialDishActivity.USERAGE, String.valueOf((SaveUtils.getAge(SocialUserListActivity.this) + Info.MIN_AGE)));
